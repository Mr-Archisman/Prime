...
function UtilityBottom() {
  ...
  return (
    ...
    <div className='bg-blue text-purplerelative flex flex-col md:flex-row tems-center justify-between mt-2 md:mt-12 pl-6 md:pl-20  pt-4'>
            ...
            <div>
              ...
              >
                ...
                <ul className='list-inside mb-4'>
                  ...
                  <li className='flex items-center mb-2'>
                    <span className='w-2 h-2 bg-purple inline-block mr-2'></span>
                    <span className='font-semibold'>IP: </span> As our collective brand grows, so does your individual Primobot.
                  </li><li className='flex items-center mb-2'>
                    <span className='w-2 h-2 bg-purple inline-block mr-2'></span>
                    <span className='font-semibold'>Effective Marketing:  </span>Marketing that goes beyond just Twitter.
                  </li>
                </ul>
              </div>
            </div>
        ...
        <Image src="/bigModel.png" alt="Primobot Logo" width={350} height={400} className="relative z-0 bottom-0 overflow-x-hidden" id="utilityBottom"/>
    </div>
  )
}
